...
| 文档 | 用途 | 模板 |
|------|------|------|
| `docs/context-snapshot.md` | ⭐ 病历摘要（新对话必读） | `assets/templates/context-snapshot.md` |
| `docs/project-map.md` | 解剖图谱 | `assets/templates/project-map.md` |
| `docs/module-registry.md` | 器官清单 | `assets/templates/module-registry.md` |
| `docs/postmortem.md` | 病例库（历史教训） | `assets/templates/postmortem.md` |
| `docs/path.md` | ⭐ 环境路径清单（部署必读） | `assets/templates/path.md` |
...
**用途**：`docs/context-snapshot.md` = 病历摘要，新对话时恢复对患者的认知。
...
- ⭐ `docs/path.md` — 环境路径清单（涉及部署、配置、Git 操作时必读）
